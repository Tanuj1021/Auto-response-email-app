...
app.get('/', async (req, res) => {
    ...
    // This is to load the client secrets from a local file.
    const credentials = await fs.readFile('credentials.json');


    // Authorizing a client with credentials and calling the Gmail API.
    ...
    async function sendReply(auth, message) {
        ...
        const replyBody = `Hello,\n\nI'm currently on a vacation and will revert back to you as soon as possible. I hope you will understand and wait.\n\nRegards,\nTanuj Saxena`;
    ...
    res.send("Thank You for subscribing to our service.");
});


app.listen(port, () => {
    console.log(`Example app successfully listening at http://localhost:${port}`);
});